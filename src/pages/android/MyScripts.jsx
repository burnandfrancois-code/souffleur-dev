    ...
    <div className="min-h-screen flex flex-col bg-background">
      <header className="sticky top-0 z-10 bg-background/95 backdrop-blur-sm border-b border-border/30 px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-display text-lg font-bold text-foreground">Mes textes</h1>
        </div>
      </header>
      ...
      <main className="flex-1 overflow-y-auto px-4 py-4">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            <p className="text-muted-foreground font-body text-sm">Aucun texte importé</p>
            <Button
          ...
          <div className="max-w-2xl mx-auto space-y-3">
            {scripts.map((script, i) => (
              ...
              >
                <div>
                  <p className="font-display font-semibold text-foreground">{script.title}</p>
                  {script.file_name && (
