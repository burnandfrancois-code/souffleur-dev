...
const MyLineRecorderAndroidFixed = forwardRef(function MyLineRecorderAndroidFixed({ line, onSubmit, onSkip, autoPlay }, ref) {
...
export default MyLineRecorderAndroidFixed;