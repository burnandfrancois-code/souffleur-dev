              ...
              {spokenUnmatched.map((word, i) => {
                ...
                return (
                  <React.Fragment key={i}>
                    {i > 0 && <span style={{ display: 'inline-block', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: '#4ade80', flexShrink: 0 }} />}
                    {isGap && <span style={{ display: 'inline-block', width: '1px', height: '20px', backgroundColor: '#4ade80', flexShrink: 0 }} />}
